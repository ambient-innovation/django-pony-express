...
class BaseEmailServiceTest(TestCase):
    ...
    def test_get_recipient_emails_regular(self):
        service = BaseEmailService(recipient_email_list=["dummy@example.com"])

        self.assertEqual(service.get_recipient_emails(), ["dummy@example.com"])

    def test_get_recipient_emails_not_set(self):
        self.assertEqual(BaseEmailService().get_recipient_emails(), [])

    def test_build_mail_object_uses_get_recipient_emails(self):
        class MyEmailService(BaseEmailService):
            subject = "My subject"
            template_name = "testapp/test_email.html"
    ...
    def test_is_valid_uses_get_recipient_emails(self):
        class MyEmailService(BaseEmailService):
            subject = "My subject"
            template_name = "testapp/test_email.html"
    ...
    def test_is_valid_get_recipient_emails_returns_ill_formatted_email(self):
        class MyEmailService(BaseEmailService):
            subject = "My subject"
            template_name = "testapp/test_email.html"
